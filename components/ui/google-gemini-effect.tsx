...
export const GoogleGeminiEffect = ({
    ...
    const translateY = useSpring(
        useTransform(scrollYProgress, [0, 0.01], [0, 850]),
        springConfig
    );
    return (
        <div className={cn("sticky top-80", className)} ref={ref} >
            {/* <Navbar /> */}
            {/* <div className="w-full h-[890px] -top-60 md:-top-40 z-10  flex items-center justify-center bg-red-transparent absolute "> */}
            {/* <ModeToggle /> */}
            <div className="w-full h-[890px] -top-60 md:-top-40 z-10  flex items-center justify-center bg-red-transparent relative ">
                <ContainerScroll
                    titleComponent={
                        <>
